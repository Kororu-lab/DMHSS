...
# Fetch and process submissions and comments in batches
...
# Score fields for submissions and comments
submission_fields = {
    'sentiment': SENTIMENT_SUBMISSION_FIELD,
    'pos': POS_FIELD,
    'graph': GRAPH_FIELD,
...
comment_fields = {
    'sentiment': SENTIMENT_COMMENT_FIELD,
    'pos': POS_FIELD,
    'graph': GRAPH_FIELD,
    'time_based': TIME_BASED_FIELD
}
...
process_documents(COLLECTION_SUBMISSIONS, submission_fields, SUBMISSION_WEIGHT)
process_documents(COLLECTION_COMMENTS, comment_fields, COMMENT_WEIGHT)
